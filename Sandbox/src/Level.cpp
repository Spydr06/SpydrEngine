...
void Level::Init()
{
	m_TriangleTexture = Spydr::Texture2D::Create("assets/textures/Triangle.png");
	m_Player.LoadAssets();
...
void Level::OnUpdate(Spydr::Timestep ts)
{
...
void Level::OnRender()
{
	...
	{
		Renderer2D::DrawRotatedQuad(pillar.TopPosition, glm::radians(180.0f), pillar.TopScale, m_TriangleTexture, 1.0f, color);
