...
#define SP_KEY_LEFT_WINDOWS       SP_LEY_LEFT_SUPER
#define SP_KEY_LEFT_CMD			  SP_KEY_LEFT_SUPER
#define SP_KEY_RIGHT_SHIFT        344
#define SP_KEY_RIGHT_CONTROL      345
#define SP_KEY_RIGHT_ALT          346
#define SP_KEY_RIGHT_SUPER        347
#define SP_KEY_RIGHT_WINDOWS      SP_LEY_RIGHT_SUPER
#define SP_KEY_RIGHT_CMD		  SP_KEY_RIGHT_SUPER
