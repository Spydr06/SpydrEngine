...
namespace Spydr
{
	...
	void OrthographicCamera::setProjection(float left, float right, float bottom, float top, float near_ , float far_ )
	{
		m_ProjectionMatrix = glm::ortho(left, right, bottom, top, near_, far_);
	}
